...
const DISHES_DATABASE = {
  it: [
    { id: 'it-soup-1', category: 'Супы', name: 'Минестроне с соусом песто', desc: 'Традиционный итальянский густой суп из сезонных овощей, фасоли и пасты, подается с ароматным базиликовым песто.', weight: '350г', info: '210 ккал', price: '380 ₽', img: "/images/minestrone.jpg" },
