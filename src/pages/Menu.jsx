...
const DISHES_DATABASE = {
  it: [
    ...
    { id: 'it-desc-1', category: 'Десерты', name: 'Классический Тирамису', desc: 'Воздушный десерт на основе печенья савоярди, пропитанного крепким свежесваренным эспрессо, и нежного крема из маскарпоне.', weight: '150г', info: '310 ккал', price: '390 ₽', img: "assets/images/tiramisu.jpg" },
