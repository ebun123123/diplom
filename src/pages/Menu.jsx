...
const DISHES_DATABASE = {
  it: [
    { id: 'it-soup-1', category: 'Супы', name: 'Минестроне с соусом песто', desc: 'Традиционный итальянский густой суп из сезонных овощей, фасоли и пасты, подается с ароматным базиликовым песто.', weight: '350г', info: '210 ккал', price: '380 ₽', img: "C:\Users\gggg8\OneDrive\Рабочий стол\diplom-project\public\images\minestrole.jpg" },
    { id: 'it-soup-2', category: 'Супы', name: 'Томатный суп с морепродуктами', desc: 'Пряный суп на основе протертых томатов Пелати с добавлением тигровых креветок, кальмаров, мидий и чесночных гренок.', weight: '400г', info: '340 ккал', price: '590 ₽', img: "C:\Users\gggg8\OneDrive\Рабочий стол\diplom-project\public\images\tomato-sup.jpg" },
    ...
    { id: 'it-desc-1', category: 'Десерты', name: 'Классический Тирамису', desc: 'Воздушный десерт на основе печенья савоярди, пропитанного крепким свежесваренным эспрессо, и нежного крема из маскарпоне.', weight: '150г', info: '310 ккал', price: '390 ₽', img: "C:\Users\gggg8\OneDrive\Рабочий стол\diplom-project\public\images\tiramisu.jpg" },
